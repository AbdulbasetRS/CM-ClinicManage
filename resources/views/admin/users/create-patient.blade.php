...
@section('title', __('admin.create_new_patient'))
...
@section('content')
    <div class="container">
                    ...
                    <div id="collapseUser" class="accordion-collapse collapse show" aria-labelledby="headingUser"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    <label for="blood_type"
                                                                        class="form-label">{{ __('admin.blood_type') }}</label>
                                                                    <select name="blood_type" id="blood_type"
                                                                        class="form-select @error('blood_type') is-invalid @enderror">
                                                                        <option value="">
                                                                            {{ __('admin.select_blood_type') }}
                                                                        </option>
                                                                        @foreach ($bloodTypes as $bloodType)
                                                                            <option value="{{ $bloodType->value }}"
                                                                                @selected(old('blood_type') == $bloodType->value)>
                                                                                {{ $bloodType->value }}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    <label for="chronic_diseases"
                                                                        class="form-label">{{ __('admin.chronic_diseases') }}</label>
                                                                    <textarea name="chronic_diseases" id="chronic_diseases"
                                                                        class="form-control @error('chronic_diseases') is-invalid @enderror">{{ old('chronic_diseases') }}</textarea>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    <label for="allergies"
                                                                        class="form-label">{{ __('admin.allergies') }}</label>
                                                                    <textarea name="allergies" id="allergies" class="form-control @error('allergies') is-invalid @enderror">{{ old('allergies') }}</textarea>
                                                                    @error('allergies')
                                                                        <div class="invalid-feedback">{{ $message }}
                                                                        </div>
                                                                    @enderror
        ...
        <div class="mt-3
                                                            ...
                                                            <button type="submit"
                                                                class="btn btn-primary">{{ __('admin.create_patient') }}</button>
