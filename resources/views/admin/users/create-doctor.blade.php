...
@section('title', __('admin.create_new_doctor'))
...
@section('content')
    <div class="container">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="can_login"
                                                                    ...
                                                                    <option value="1" @selected(old('can_login', true))>
                                                                        {{ __('admin.yes') }}
                                                                    </option>
                                                                    <option value="0" @selected(!old('can_login', true))>
                                                                        {{ __('admin.no') }}</option>
                                                                </select>
                                                                @error('can_login')
                                                                    <div class="invalid-feedback">
        ...
        <div class="mt-3
                                                            ...
                                                            <button type="submit"
                                                                class="btn btn-primary">{{ __('admin.create_doctor') }}</button>
